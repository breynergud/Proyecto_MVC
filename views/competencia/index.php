...
<main class="main-content">
    ...
    <header class="main-header">
        <div class="header-content">
            ...
            <h1 class="page-title">Administración de Competencias</h1>
        </div>
    ...
    <div class="content-wrapper">
        ...
        <div class="action-bar-simple" style="display: flex; justify-content: space-between; align-items: center;">
            <div class="search-container">
                ...
                <input type="text" id="searchInput" placeholder="Buscar por nombre o norma..." class="search-input">
            </div>
...
<div id="deleteModal" class="modal">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <p>¿Está seguro que desea eliminar la competencia <strong id="competenciaToDelete"></strong>?</p>
